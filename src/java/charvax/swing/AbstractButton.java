...
public abstract class AbstractButton
    ...
    /**
     * Gets this button's underlying model.
     *
    ...
    /**
     * Sets this button's underlying model.
     *
     * @param model_ The ButtonModel.
     */
    public void setModel (ButtonModel model_) {
        _model = model_;
    }
...
//	super.requestFocus();
    ...
    public void setSelected(boolean state_) {
        ...
        getModel().setSelected(state_);
        if (isDisplayed())
            super.repaint();
    }

    void setSelectedInGroup (boolean state_) {
      getModel().setSelected(state_);
    }
